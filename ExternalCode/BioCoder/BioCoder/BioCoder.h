...
\par Output:
\htmlonly Perform 0.8% agarose gel electrophoresis of (array1[0].contents.name) and (array1[1].contents.name)(5痞 sample and 1痞 of loading buffer), mixed with ethidium bromide
and visualize with UV transilluminator to confirm the presence of required product. \endhtmlonly
\sa nanodrop()
*/
...
\par Output:
\htmlonly Dilute to <font color=#357EC7>100ng/ 無</font> and send <font color=#357EC7>1 痢 (10 無)</font> for sequencing. \endhtmlonly
