 ...
 *
<<<<<<< HEAD
 * $Id: LayoutExtensionTypes.h 2657 2011-10-05 21:28:22Z dchandran1 $
 * $HeadURL: svn://svn.code.sf.net/p/tinkercell/code/trunk/ExternalCode/sbml/src/sbml/packages/layout/common/LayoutExtensionTypes.h $
=======
 * $Id$
 * $HeadURL$
