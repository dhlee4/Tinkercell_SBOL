 ...
 * $Id: SBWMethodNotFoundException.h,v 1.1 2005/12/15 01:06:44 fbergmann Exp $
 * $Source: /cvsroot/sbw/core/include/SBW/SBWMethodNotFoundException.h,v $
 */
...
class SBWMethodNotFoundException : public SBWException  
{
public :
	/**
	 ...
	 */	
	SBWMethodNotFoundException(const char *x) : SBWException(x) {}

	/**
	 * create an exception with just a user message.
	 * @param x user message.
	 */	
	SBWMethodNotFoundException(std::string x) : SBWException(x) {}
	 ...
	 */
	SBWMethodNotFoundException(std::string a, std::string b) : SBWException(a, b) {}
