 ...
 * $Id: SBWBrokerStartException.h,v 1.1 2005/12/15 01:06:44 fbergmann Exp $
 * $Source: /cvsroot/sbw/core/include/SBW/SBWBrokerStartException.h,v $
 */
...
class SBWBrokerStartException : public SBWException  
{
public :
	/**
	 ...
	 */	
	SBWBrokerStartException(const char *x) : SBWException(x) {}

	/**
	 * create an exception with just a user message.
	 * @param x user message.
	 */	
	SBWBrokerStartException(std::string x) : SBWException(x) {}
	 ...
	 */
	SBWBrokerStartException(std::string a, std::string b) : SBWException(a, b) {}
