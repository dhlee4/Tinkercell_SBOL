...
// folder structure
// set using CMake
#define SBOL_SOURCE_DIR  "H:/code/libSBOLc/source"  ///< Holds source code for libSBOLc.
#define SBOL_ROOT_DIR    "H:/code/libSBOLc"    ///< Top-level project folder.
#define SBOL_BUILD_DIR   "H:/code/libSBOLc/build"   ///< Folder for temporary build files.
#define SBOL_SCHEMA_DIR  "H:/code/libSBOLc/schema"  ///< Holds the SBOL schema files.
#define SBOL_TEST_DIR    "H:/code/libSBOLc/tests"    ///< Holds source code for the tests.
#define SBOL_EXAMPLE_DIR "H:/code/libSBOLc/examples" ///< Holds example SBOL documents and code.
#define SBOL_RELEASE_DIR "H:/code/libSBOLc/release" ///< Folder for generated binaries, docs, etc.
#define SBOL_MANUAL_DIR  "H:/code/libSBOLc/manual"  ///< Holds source code for the SBOL manual.
